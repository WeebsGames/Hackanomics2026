...
namespace UshiSoft.UACPF
{
    ...
    public class PlayerCarControl : DriverBase
    {
        ...
        private float GetRawThrottleInput()
        {
            ...
            if (Keyboard.current.upArrowKey.isPressed || Keyboard.current.wKey.isPressed || Keyboard.current.cKey.isPressed)
            {
                return 1f;
            }
        ...
        private float GetRawBrakeInput()
        {
            ...
            if (Keyboard.current.downArrowKey.isPressed || Keyboard.current.sKey.isPressed || Keyboard.current.xKey.isPressed)
            {
                return 1f;
            }
